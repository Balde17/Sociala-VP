...
func (b *SQLBuilder) NotWhere(column string, value interface{}) *SQLBuilder {
	b.query += " WHERE " + column + " != ?"
	b.parameters = append(b.parameters, value)
	return b
}
...
func (b *SQLBuilder) NotAnd(column string, value interface{}) *SQLBuilder {
	b.query += " AND " + column + " != ?"
	b.parameters = append(b.parameters, value)
	return b
}
...
func (b *SQLBuilder) OrderBy(column, order string) *SQLBuilder {
	b.query += " ORDER BY " + column + " " + order
	return b
}
